...
import scriptText5 from '../data/scriptData5';

function ScriptInfo3({id, desc, codeView, preCode, clas, codeText, language, handleButonClick}){
        ...
        <div className={clas}>
            {
                ...
                <>
                    <div className="desc">
                        <ul>
                            <li><a href="/script" className="link">1</a></li>
                            <li><a href="/script2" className="link">2</a></li>
                            <li><a href="/" className="link">3</a></li>
                            <li><a href="/script3" className="link">4</a></li>
                            <li><a href="/script4" className="link">5</a></li>
                            <li><a href="/script5" className="link">6</a></li>
                        </ul>
                                    ...
                                    <>
                                        ...
                                        <div><span className="view">{codeText}</span></div>
                                            ...
                                            clas === "box9 site__desc" ?
                                                    <div className="desc">
                                                        <h3>{scriptText5[8].desc}</h3>
                                                        <p>{scriptText5[8].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText5[8].preCode}
                                                            </code></pre>
                                                        </div>
                                                        <h3>{scriptText5[9].desc}</h3>
                                                        <p>{scriptText5[9].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText5[9].preCode}
                                                            </code></pre>
                                                        </div>  
                                                        <h3>{scriptText5[10].desc}</h3>
                                                        <p>{scriptText5[10].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText5[10].preCode}
                                                            </code></pre>
                                                        </div>                                                                                          
                                                    </div>
                                                : (
