...
import scriptText4 from '../data/scriptData4';
                ...
                <>
                    <div className="desc">
                        <ul>
                            ...
                            <li><a href="/" className="link">4</a></li>
                                    ...
                                    <>
                                        ...
                                        <div><span className="view">{codeText}</span></div>
                                            ...
                                            clas === "box9 site__desc" ?
                                                    <div className="desc">
                                                        <h3>{scriptText4[8].desc}</h3>
                                                        <p>{scriptText4[8].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText4[8].preCode}
                                                            </code></pre>
                                                        </div>
                                                        <h3>{scriptText4[9].desc}</h3>
                                                        <p>{scriptText4[9].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText4[9].preCode}
                                                            </code></pre>
                                                        </div>                                                                                          
                                                    </div>
                                                : (
