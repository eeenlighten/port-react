...
import reactText3 from '../data/reactData3';
                    ...
                    <div className="desc">
                        <ul>
                            <li><a href="/react" className="link">1</a></li>
                                <li><a href="/react2" className="link">2</a></li>
                                    ...
                                    <>
                                        ...
                                        <div><span className="view">{codeText}</span></div>
                                            ...
                                            clas === "box9 site__desc" ?
                                                    <div className="desc">
                                                        <h3>{reactText3[8].desc}</h3>
                                                        <p>{reactText3[8].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {reactText3[8].preCode}
                                                            </code></pre>
                                                        </div>
                                                        <h3>{reactText3[9].desc}</h3>
                                                        <p>{reactText3[9].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {reactText3[9].preCode}
                                                            </code></pre>
                                                        </div>                                                                                          
                                                    </div>
                                                : (
