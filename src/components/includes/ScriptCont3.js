...
import scriptText3 from '../data/scriptData3';
                                    ...
                                    <>
                                        ...
                                        <div><span className="view">{codeText}</span></div>
                                            ...
                                            clas === "box9 site__desc" ?
                                                    <div className="desc">
                                                        <h3>{scriptText3[8].desc}</h3>
                                                        <p>{scriptText3[8].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText3[8].preCode}
                                                            </code></pre>
                                                        </div>
                                                        <h3>{scriptText3[9].desc}</h3>
                                                        <p>{scriptText3[9].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText3[9].preCode}
                                                            </code></pre>
                                                        </div>  
                                                        <h3>{scriptText3[10].desc}</h3>
                                                        <p>{scriptText3[10].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText3[10].preCode}
                                                            </code></pre>
                                                        </div>                                                                                          
                                                    </div>
                                                : (
