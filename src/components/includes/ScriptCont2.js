...
import scriptText2 from '../data/scriptData2';

function ScriptInfo2({id, desc, codeView, preCode, clas, codeText, language, handleButonClick}){
                                    ...
                                    <>
                                        ...
                                        <div><span className="view">{codeText}</span></div>
                                            ...
                                            clas === "box9 site__desc" ?
                                                    <div className="desc">
                                                        <h3>{scriptText2[8].desc}</h3>
                                                        <p>{scriptText2[8].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText2[8].preCode}
                                                            </code></pre>
                                                        </div>
                                                        <h3>{scriptText2[9].desc}</h3>
                                                        <p>{scriptText2[9].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText2[9].preCode}
                                                            </code></pre>
                                                        </div>  
                                                        <h3>{scriptText2[10].desc}</h3>
                                                        <p>{scriptText2[10].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {scriptText2[10].preCode}
                                                            </code></pre>
                                                        </div>                                                                                          
                                                    </div>
                                                : (
