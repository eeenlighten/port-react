...
import vueText from '../data/vueData';
                ...
                <>
                    <div className="desc">
                        <ul>
                            ...
                            <li><a href="/" className="link">5</a></li>
                        </ul>
                                    ...
                                    <>
                                        ...
                                        <div><span className="view">{codeText}</span></div>
                                            ...
                                            clas === "box9 site__desc" ?
                                                    <div className="desc">
                                                        <h3>{vueText[8].desc}</h3>
                                                        <p>{vueText[8].codeView}</p> 
                                                        <div className="code">
                                                        ...
                                                        <h3>{vueText[9].desc}</h3>
                                                        <p>{vueText[9].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {vueText[9].preCode}
                                                        ...
                                                        <h3>{vueText[10].desc}</h3>
                                                        <p>{vueText[10].codeView}</p> 
                                                        <div className="code">
                                                            <pre><code className={`language-${language}`}>
                                                                <br />
                                                                {vueText[10].preCode}
